/* empty css                          */
import { A as AstroError, k as InvalidImageService, l as ExpectedImageOptions, E as ExpectedImage, n as FailedToFetchRemoteImageDimensions, d as createAstro, e as createComponent, o as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, f as addAttribute, s as spreadAttributes, i as renderSlot, g as renderComponent } from '../astro_0_9Cd_Bh.mjs';
import { $ as $$Layout, g as getI18N } from './404_D6nsvfa7.mjs';
import { i as isRemoteImage, b as isESMImportedImage, c as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_DveqkFi1.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_DveqkFi1.mjs'
    ).then(n => n.g).catch((e) => {
...
}, "/Users/albert/Sites/curso-astro-2024/node_modules/.pnpm/astro@4.4.1/node_modules/astro/components/Image.astro", void 0);
...
}, "/Users/albert/Sites/curso-astro-2024/node_modules/.pnpm/astro@4.4.1/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[]};
					new URL("file:///Users/albert/Sites/curso-astro-2024/.vercel/output/static/");
...
const image = new Proxy({"src":"/_astro/author.BuwJRqq2.webp","width":553,"height":837,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/albert/Sites/curso-astro-2024/src/assets/images/author.webp";
							}
...
const $$About$2 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": t.about.SEO_TITLE }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex gap-8"> <div> ${renderComponent($$result2, "Picture", $$Picture, { "src": image, "widths": [240, 540, image.width], "sizes": `(max-width: 360px) 240px, (max-width: 720px) 540px, ${image.width}px`, "formats": ["webp", "avif", "jpeg"], "alt": "Author", "class": "rounded-lg" })} </div> <div class="prose">  <h1>${t.about.PAGE_TITLE}</h1> <p> ${t.about.PAGE_TEXT_01} </p> <p> ${t.about.PAGE_TEXT_02} </p> ${renderComponent($$result2, "Button", $$Button, { "href": "/", "type": "primary" }, { "default": ($$result3) => renderTemplate`${t.about.BUTTON_CTA}` })} </div> </div> ` })}`;
...
export { $$Button as $, about$1 as a, about as b, getConfiguredImageService as g, imageConfig as i };
