/* empty css                          */
import { A as AstroError, c as MissingLocale, d as createAstro, e as createComponent, r as renderTemplate, m as maybeRenderHead, f as addAttribute, g as renderComponent, h as renderHead, i as renderSlot } from '../astro_0_9Cd_Bh.mjs';
import { a as appendForwardSlash, j as joinPaths } from '../astro/assets-service_DveqkFi1.mjs';
/* empty css                          */
...
var define_ASTRO_INTERNAL_I18N_CONFIG_default = { base: "/", format: "directory", trailingSlash: "ignore", i18n: { defaultLocale: "en", locales: ["es", "en"], routing: "pathname-prefix-other-locales" }, isBuild: true };
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<header class="container flex justify-between items-center py-6"> <h1 class="text-4xl text-teal-500 font-bold"> <a href="/">Astro Blog</a> </h1> <nav> <ul class="flex items-center gap-6"> ${renderComponent($$result, "Menu", $$Menu, {})} </ul> </nav> ${renderComponent($$result, "LangSwitcher", $$LangSwitcher, {})} </header>`;
