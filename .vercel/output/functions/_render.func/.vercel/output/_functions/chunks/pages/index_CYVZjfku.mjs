/* empty css                          */
import { d as createAstro, e as createComponent, r as renderTemplate, m as maybeRenderHead, f as addAttribute, j as renderTransition, g as renderComponent } from '../astro_nnZpuxeB.mjs';
import { a as getRelativeLocaleUrl, $ as $$Layout, g as getI18N } from './404_DNCzXoZQ.mjs';
/* empty css                          */
import { A as Accordion } from './elements_DQy62hvA.mjs';
...
const $$Home = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to Astro." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h1 class="text-3xl font-bold text-center mb-8">${t.home.PAGE_TITLE}</h1>   <div class="grid grid-cols-1 lg:grid-cols-2 gap-8"> ${articles.map((article) => renderTemplate`${renderComponent($$result2, "Card", $$Card, { "article": article })}`)} </div> <div class="my-10"> <!-- 👇 La directiva "client:visible" Se utiliza para cargar el JavaScript solo cuando el elemento sea visible  --> ${renderComponent($$result2, "Accordion", Accordion, { "title": "Why should you need to do this?", "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@components/Accordion.jsx", "client:component-export": "Accordion" }, { "default": ($$result3) => renderTemplate` <p class="mt-4">
