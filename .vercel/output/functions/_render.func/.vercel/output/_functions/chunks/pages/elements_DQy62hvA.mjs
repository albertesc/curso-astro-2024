/* empty css                          */
import { d as createAstro, e as createComponent, r as renderTemplate, g as renderComponent, m as maybeRenderHead, F as Fragment, k as createTransitionScope } from '../astro_nnZpuxeB.mjs';
import { $ as $$Layout } from './404_DNCzXoZQ.mjs';
import { $ as $$Button } from './about_CFReq-QY.mjs';
...
const $$Elements$2 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "UI Elements" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<h1 class="text-2xl">UI Elements Examples</h1> <div class="flex items-center flex-wrap gap-4 mb-4"> ${renderComponent($$result2, "Button", $$Button, { "href": "/", "type": "primary" }, { "default": ($$result3) => renderTemplate`Button` })} ${renderComponent($$result2, "Button", $$Button, { "href": "/", "type": "primary", "size": "small" }, { "default": ($$result3) => renderTemplate`Button` })} ${renderComponent($$result2, "Button", $$Button, { "href": "/", "type": "primary", "size": "large" }, { "default": ($$result3) => renderTemplate`Button` })} ${renderComponent($$result2, "Button", $$Button, { "href": "/", "type": "secondary" }, { "default": ($$result3) => renderTemplate`Secondary Button` })} ${renderComponent($$result2, "Button", $$Button, { "href": "/", "type": "secondary", "size": "small" }, { "default": ($$result3) => renderTemplate`Secondary Button` })} ${renderComponent($$result2, "Button", $$Button, { "href": "/", "type": "secondary", "size": "large" }, { "default": ($$result3) => renderTemplate`Secondary Button` })} ${renderComponent($$result2, "Button", $$Button, { "href": "/", "type": "primary" }, { "default": ($$result3) => renderTemplate` 
Button
