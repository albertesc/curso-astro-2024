/* empty css                          */
import { d as createAstro, e as createComponent, r as renderTemplate, g as renderComponent, m as maybeRenderHead, f as addAttribute, j as renderTransition, F as Fragment, u as unescapeHTML } from '../astro_nnZpuxeB.mjs';
...
const $$id$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const article = await fetch(`/api/article/${id}.json`).then(
    (res) => res.json()
  );
